 ...
 * @property premium Indica si el cliente tiene membresía premium (true) o no (false).
 */
data class Cliente(
    ...
    val fechaRegistro: String, // Fecha de registro del cliente
    var premium: Boolean // Indica si el cliente es premium o no
)
