package com.example.vaultix.act.clientes
...
import com.example.vaultix.act.transaction.TransactionActivity
...
class ClientesActivity : AppCompatActivity() {
    ...
    private fun mostrarOpcionesCliente(cliente: Cliente) {
        val opciones = arrayOf("Actualizar", "Eliminar", "Ver Transaction")
